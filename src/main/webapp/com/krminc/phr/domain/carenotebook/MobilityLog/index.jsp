...
<%-- 
    Document   : index
    Created on : Mar 27, 2012, 11:44:29 AM
    Author     : cmccall
--%>
...
<head>
    ...
    <title>HealtheMe - Care Notebook - Mobility Log</title>
    <meta name="requiresJQUI" content="true">
...
<!--    <script type="text/javascript" src="${ctx_static}/js/validate.mobility.js"></script>-->
...
<body id="logs-mi" class="logs">

        <h1>Mobility Log</h1>

        <div class="def-container">
            <div class="def-title">Purpose</div>
            Use this page to talk about your child's ability to get around. Describe how your child gets around. Include what your child can do by him or herself and any help or assistive technology your child uses to get around. Describe any activity limitation and any special routines your child has for transfers, pressure releases, positioning, etc.
        </div>
        <br />

    <form class="mobilityform carenotebook" action="${ctx}/form/care/${ it.healthRecordId }/mobility/post/" method="post" enctype="application/x-www-form-urlencoded">
        

    <c:if test="${it.class.simpleName == 'MobilityLog'}">
        <c:forEach items="${it.log}" var="log" varStatus="status">
            ...
            <input type="hidden" id="mobilityId_${status.count}" name="mobilityId_${status.count}" value="${ log.mobilityId }" />
            ...
            <br />
            <textarea id="mobilityText_${status.count}" name="mobilityText_${status.count}" rows="10" cols="20">${ log.mobilityText }</textarea>
            <br />
        ...
        <div class="add">
            <a title="Add Another Mobility Log Entry" id="addForm" href="#">Add Another Mobility Log Entry</a>
        </div>
