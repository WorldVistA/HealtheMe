...
<%-- 
    Document   : edit
    Created on : Oct 16, 2009, 8:55:22 AM
    Author     : cmccall
--%>
...
<html>
<head>
    <title>Vitals - Weight - Edit</title>
    <meta name="requiresJQUI" content="true">
    <meta name="requiresValidation" content="true">
    <script type="text/javascript" src="${ctx_static}/js/validate.vital.weight.js"></script>
    <script type="text/javascript">
        var baseuri = '${ctx_patient}';
        var url = "${apipath}/patients/${it.healthRecordId}/vitals/weight/${ it.weightId }/";
        ...
        $(document).ready(function() {
            ...
            $("#unit option[value='${it.unit}']").attr("selected", true);
        });
...
<body bgcolor="#ffffff" text="#000000" link="#0000cc" vlink="#551a8b" alink="#ff0000">
    <div id="lightBox">
        <div id="m_lightBox">
            <h1>Edit Body Weight</h1>

            <span class="toolSummary">Note: This Weight reading will appear under 'Self Entered' data.</span>

            <form id="detailform" name="detailform" action="./formhandler/" method="post">
            <input type="hidden" id="sourceurl" name="sourceuri" value="${ctx}/vitals/weight/${it.weightId}/edit" />
            <input type="hidden" id="returnurl" name="returnurl" value="${ctx}/vitals/weight" />
            ...
            <input type="hidden" id="weightid" name="weightid" value="${it.weightId}" />
                ...
                <div>
                    <span class="fldgroup">
                        <div class="hv_element">
                            ...
                            <input class="hv_element_level_input" maxlength="30" id="weight" name="weight" value="${it.weight}"/>
                        </div>
                    </span>
                    <span class="fldgroup">
                        <div class="hv_element">
