...
<%-- 
    Document   : edit
    Created on : Oct 19, 2009, 1:38:40 PM
    Author     : cmccall
--%>
...
<html>
<head>
    <title>Vitals - Pulse - Edit</title>
    <meta name="requiresJQUI" content="true">
    <meta name="requiresValidation" content="true">
    <script type="text/javascript" src="${ctx_static}/js/validate.vital.heartrate.js"></script>
    <script type="text/javascript">
        var baseuri = '${ctx_patient}';
        var url = "${apipath}/patients/${it.healthRecordId}/vitals/heartrate/${ it.heartRateId }/";
...
<body bgcolor="#ffffff" text="#000000" link="#0000cc" vlink="#551a8b" alink="#ff0000">
    <div id="lightBox">
        <div id="m_lightBox">
            ...
            <span class="toolSummary">Note: This heart rate reading will appear under 'Self Entered' data.</span>

            <form id="detailform" name="detailform" action="./formhandler/" method="post">
            <input type="hidden" id="sourceurl" name="sourceuri" value="${ctx}/vitals/heartrate/${it.heartRateId}/edit" />
            <input type="hidden" id="returnurl" name="returnurl" value="${ctx}/vitals/heartrate" />
            ...
            <input type="hidden" id="heartrateid" name="heartrateid" value="${it.heartRateId}" />

            <div class="ie">
                <div class="hv_element">
                    <label for="rate">Pulse Value<span class="required">*</span></label>
                    <input class="hv_element_level_input" maxlength="30" id="rate" name="rate" value="${it.rate}"/>&nbsp;BPM
                </div>
