...
<head>
    ...
    <title>HealtheMe - Health Record - Vitals - Pulse</title>
...
<body id="vitals-hr" class="vitals">
    ...
    <div class="def-container">
        ...
        The number of times your heart beats per minute.  Excessively high, low, or irregular rates can indicate a wide variety of conditions.
    </div>
    ...
    <div id="ajax-container">
        <div id="widget-container">
            <div id="pulse-widget" class="widget">
                <div class="expander">
                ...
                <div id="controls">
               		<div class="add">
                    	<a class="addlink" href="${ctx_patient}/${it.healthRecordId}/heartrate-add" title="Add Record">Add Record</a>
                    </div>
                  	<div class="sorter">
                        <form id="sorting" action="#" method="post">
                            <label for="sort">Sort by</label>
                            <select name="sort" id="sort">
                                <option value="value" class="selfSort clinicalSort asc">Pulse: ascending</option>
                                <option value="value" class="selfSort clinicalSort desc">Pulse: descending</option>
                                ...
                                <td class="col5">
                                    <div class="d">
                                        <ul class="actionButtons">
                                            <li class="edit">
                                                <a href="#" class="changelink" title="Edit Pulse Reading"></a>
                                            </li>
                                            <li class="delete">
                                                <a href="#" title="Delete Pulse Reading" class="deletelink"></a>
                                            </li>
                                        </ul>
                                   </div>
                                </td>
