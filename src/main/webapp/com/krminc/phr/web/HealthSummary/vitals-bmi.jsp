...
<head>
    ...
    <title>HealtheMe - Health Record - Vitals - Body Mass Index</title>
    ...
    var pagePath = "${ctx_patient}" + "/${it.healthRecordId}/vitals/bmi/";
    var patientId = ${it.healthRecordId};
    var max = ${numResults}; //num per page
    var orderBy = "observeddate"; //must match first item in Sort DDL
    var midPath = "/patients/${it.healthRecordId}/stats/";
    var clinPath = "/clinical/vitals/bmi/";
    </script>
    <script language="javascript" src="${ctx_static}/js/widget_bmi.js"></script>

</head>
<body id="vitals-bmi" class="vitals">
    ...
    <div id="ajax-container">
        <div id="widget-container">
            <div id="bmi-widget" class="widget">
                <div class="expander">
                  	...
                  	<div class="sorter">
                        <form id="sorting" action="#" method="post">
                            ...
                            <select name="sort" id="sort">
                            	...
                            	<option value="addeddate" class="clinicalSort desc">Date Added: recent first</option>
                            </select>
                        </form>
                    </div>--%>
                    <div class="clear"> </div>
                ...
                <div id="tabs-content">
                    ...
                    <div id="bmi-info">
                        ...
                        <h3>The calculations below are based on your latest 'self entered' values</h3>
                        
                        <div id="bmi-stats" class="ui-helper-hidden">
                            <div id="has-height">Your most recent height is <span class="recent-height"></span>, taken <span class="recent-height-date"></span>.</div>
                            <div id="no-height">You have no recent height entries.</div>
                            <div id="has-weight">Your most recent weight is <span class="recent-weight"></span>, taken <span class="recent-weight-date"></span>.</div>
                            <div id="no-weight">You have no recent weight entries.</div>
                            <div id="has-bmi">Based on these values, your calculated BMI is <span class="recent-bmi"></span>.</div>
                            <div id="no-bmi">BMI not available until height and weight measurements are entered.</div>
                            
                            <p>This information is also displayed in your profile under 'Current Health Stats'.</p>
                        </div>
    
                        <%--<table>
                            <tr>
                                <th colspan="0">BMI Categories</th>
                            </tr>
                            <tr>
                                <td>Underweight</td>
                                <td>BMI < 18.5</td>
