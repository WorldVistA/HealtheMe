...
<head>
    ...
    <title>HealtheMe - Health Record - Vitals - Body Height</title>
...
<body id="vitals-ht" class="vitals">
    ...
    <div class="def-container">
        ...
        How tall you are.  This is most valuable when viewed in relation to your weight to determine your Body Mass Index; an indicator of your general health.  Tracked over time, this may also help ensure a developing individual is growing at an appropriate rate.
    </div>
    ...
    <div id="ajax-container">
        <div id="widget-container">
            <div id="height-widget" class="widget">
                <div class="expander">
                ...
                <div id="controls">
               		<div class="add">
                    	<a class="addlink" href="${ctx_patient}/${it.healthRecordId}/height-add" title="Add Record">Add Record</a>
                    </div>
                  	<div class="sorter">
                        <form id="sorting" action="#" method="post">
                            <label for="sort">Sort by</label>
                            <select name="sort" id="sort">
                                <option value="value" class="selfSort clinicalSort asc">Body Height: ascending</option>
                                <option value="value" class="selfSort clinicalSort desc">Body Height: descending</option>
                    ...
                    <table id="vtls-bp" class="grs1">
                        <tbody>
                            ...
                            <tr class="rowtemplate selfentered ui-helper-hidden">
                                ...
                                <td class="col3">
                                	<div class="d b">
                                    	<span class="feet"></span>'&nbsp;<span class="inches" ></span>"
                                    </div>
                                </td>
                                <td class="col4">
                                    <div class="d">&nbsp;</div>
                                ...
                                <td class="col5">
                                    <div class="d">
                                        <ul class="actionButtons">
                                            <li class="edit">
                                                <a href="#" class="changelink" title="Edit Body Height Reading"></a>
                                            </li>
                                            <li class="delete">
                                                <a href="#" title="Delete Body Height Reading" class="deletelink"></a>
                                            </li>
                                        </ul>
                                   </div>
                                </td>
