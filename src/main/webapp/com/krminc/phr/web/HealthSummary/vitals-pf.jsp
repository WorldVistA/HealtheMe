...
<head>
    ...
    <title>HealtheMe - Health Record - Vitals - Peak Flow</title>
...
<body id="vitals-pf" class="vitals">
    ...
    <div class="def-container">
        ...
        A measure of your ability to breath out air.  Monitoring this over time may help diagnose medical conditions such as Asthma, and track general respiratory function.
    </div>
    ...
    <div id="ajax-container">
        <div id="widget-container">
            <div id="peakflow-widget" class="widget">
                <div class="expander">
                ...
                <div id="controls">
               		<div class="add">
                    	<a class="addlink" href="${ctx_patient}/${it.healthRecordId}/peakflow-add" title="Add Record">Add Record</a>
                    </div>
                  	<div class="sorter">
                        <form id="sorting" action="#" method="post">
                            <label for="sort">Sort by</label>
                            <select name="sort" id="sort">
                                <option value="value" class="selfSort clinicalSort asc">Peak Flow: ascending</option>
                                <option value="value" class="selfSort clinicalSort desc">Peak Flow: descending</option>
                                ...
                                <td class="col5">
                                    <div class="d">
                                        <ul class="actionButtons">
                                            <li class="edit">
                                                <a href="#" class="changelink" title="Edit Flow Reading"></a>
                                            </li>
                                            <li class="delete">
                                                <a href="#" title="Delete Flow Reading" class="deletelink"></a>
                                            </li>
                                        </ul>
                                   </div>
                                </td>
