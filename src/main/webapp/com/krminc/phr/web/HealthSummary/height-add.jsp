...
<%-- 
    Document   : height-add
    Created on : Oct 19, 2009, 3:16:15 PM
    Author     : cmccall
--%>
...
<head>
    ...
    <title>Vitals - Height - Add</title>
    <meta name="requiresJQUI" content="true">
    <meta name="requiresValidation" content="true">
    <script type="text/javascript">
        var url = "${apipath}/patients/${it.healthRecordId}/vitals/height/";
    ...
    <script type="text/javascript" src="${ctx_static}/js/validate.vital.height.new.js"></script>
    <link rel="stylesheet" type="text/css" href="${ctx_static}/css/iframe.css" media="screen, print"/>
</head>
<body bgcolor="#ffffff" text="#000000" link="#0000cc" vlink="#551a8b" alink="#ff0000">
    <div id="lightBox">
        <div id="m_lightBox">
            <h1>Add Body Height</h1>
                
            <span class="toolSummary">Note: This height measurement will appear under 'Self Entered' data.</span>

            <form id="detailform" name="detailform" action="./formhandler/" method="post">
            <input type="hidden" id="sourceurl" name="sourceuri" value="${ctx_patient}/${it.healthRecordId}/vitals/height-add/" />
            <input type="hidden" id="returnurl" name="returnurl" value="${ctx_patient}/${it.healthRecordId}/vitals/height" />
                ...
                <div>
                    <span class="fldgroup">
                        <div class="hv_element">
                            ...
                            <input class="hv_element_level_input" maxlength="30" id="feet" name="feet" />
                        </div>
                    </span>
                    <span class="fldgroup">
                        <div class="hv_element">
                            <label for="Inches">Inches<span class="required">*</span></label>
                            <input class="hv_element_level_input" maxlength="30" id="inches" name="inches" />
                        </div>
                    </span>
                </div>
                <div class="clear"> </div>
