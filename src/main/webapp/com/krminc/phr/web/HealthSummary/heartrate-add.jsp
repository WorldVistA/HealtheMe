...
--%>
<%-- 
    Document   : heartrate-add
    Created on : Oct 19, 2009, 1:37:12 PM
    Author     : cmccall
--%>
...
<head>
    ...
    <title>Vitals - Pulse - Add</title>
    <meta name="requiresJQUI" content="true">
    <meta name="requiresValidation" content="true">
    <script type="text/javascript">
        var url = "${apipath}/patients/${it.healthRecordId}/vitals/heartrate/";
    ...
    <script type="text/javascript" src="${ctx_static}/js/validate.vital.heartrate.new.js"></script>
...
<body bgcolor="#ffffff" text="#000000" link="#0000cc" vlink="#551a8b" alink="#ff0000">
    <div id="lightBox">
        <div id="m_lightBox">
            ...
            <span class="toolSummary">Note: This pulse will appear under 'Self Entered' data.</span>

            <form id="detailform" name="detailform" action="./formhandler/" method="post">
            <input type="hidden" id="sourceurl" name="sourceuri" value="${ctx_patient}/${it.healthRecordId}/vitals/heartrate-add/" />
            <input type="hidden" id="returnurl" name="returnurl" value="${ctx_patient}/${it.healthRecordId}/vitals/heartrate" />
            ...
            <div class="ie">
                <div class="hv_element">
                    ...
                    <input class="hv_element_level_input" maxlength="30" id="rate" name="rate" />&nbsp;BPM
                </div>
