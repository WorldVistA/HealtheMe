...
<head>
    ...
    <title>HealtheMe - Health Record - Vitals - Temperature</title>
...
<body id="vitals-bt" class="vitals">
    ...
    <div class="def-container">
        ...
        The measure of how warm or cool your body is.  When viewed relative to your standard body temperature, high or low readings can indicate a wide variety of medical conditions or illnesses.
    </div>
    ...
    <div id="ajax-container">
        <div id="widget-container">
            <div id="temperature-widget" class="widget">
                ...
                <div id="controls">
               		<div class="add">
                    	<a class="addlink" href="${ctx_patient}/${it.healthRecordId}/temperature-add" title="Add Record">Add Record</a>
                    </div>
                  	<div class="sorter">
                        <form id="sorting" action="#" method="post">
                            <label for="sort">Sort by</label>
                            <select name="sort" id="sort">
                                <option value="value" class="selfSort clinicalSort asc">Body Temperature: ascending</option>
                                <option value="value" class="selfSort clinicalSort desc">Body Temperature: descending</option>
                        ...
                        <tbody>
                            <tr class="titletemplate selfentered ui-helper-hidden">
                                ...
                                <th class="selfentered col3">
                                	<div class="d">Body Temperature</div>
                                </th>
                                <th class="selfentered col4">
                                	<div class="d">Method</div>
                                </th>
                                <th class="selfentered col5">
                                	<div class="d">&nbsp;</div>
                                </th>
                                <th class="selfentered col6">
                                	<div class="d">&nbsp;</div>
                                </th>
                            </tr>
                            ...
                            <tr class="rowtemplate selfentered ui-helper-hidden">
                                ...
                                <td class="col3">
                                	<div class="d b">
                                    	<span class="temperature"></span>&nbsp;&deg;<span class="unit" ></span>
                                    </div>
                                </td>
                                <td class="col4">
                                	<div class="d">
                                ...
                                <td class="col6">
                                    <div class="d">
                                        <ul class="actionButtons">
                                            <li class="edit">
                                                <a href="#" class="changelink" title="Edit Body Temperature Reading"></a>
                                            </li>
                                            <li class="delete">
                                                <a href="#" title="Delete Body Temperature Reading" class="deletelink"></a>
                                            </li>
                                        </ul>
                                   </div>
                                </td>
                            ...
                            <tr class="detailtemplate selfentered ui-helper-hidden">
                                <td colspan="6" class="testContainerRow">
