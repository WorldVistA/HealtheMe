...
--%>
<%-- 
    Document   : temperature-add
    Created on : Oct 15, 2009, 2:41:03 PM
    Author     : cmccall
--%>
...
<head>
    ...
    <title>Vitals - Temperature - Add</title>
    <meta name="requiresJQUI" content="true">
    <meta name="requiresValidation" content="true">
    <script type="text/javascript">
        var url = "${apipath}/patients/${it.healthRecordId}/vitals/temperature/";
    ...
    <script type="text/javascript" src="${ctx_static}/js/validate.vital.temperature.new.js"></script>
    <link rel="stylesheet" type="text/css" href="${ctx_static}/css/iframe.css" media="screen, print"/>
</head>
<body bgcolor="#ffffff" text="#000000" link="#0000cc" vlink="#551a8b" alink="#ff0000">
    <div id="lightBox">
        <div id="m_lightBox">
            <h1>Add Body Temperature</h1>
            ...
            <input type="hidden" id="sourceurl" name="sourceuri" value="${ctx_patient}/${it.healthRecordId}/vitals/temperature-add/" />
            <input type="hidden" id="returnurl" name="returnurl" value="${ctx_patient}/${it.healthRecordId}/vitals/temperature" />
            ...
            <div class="ie">
                <div class="hv_element">
                    ...
                    <input class="hv_element_level_input" maxlength="30" id="temperature" name="temperature" />&nbsp;&deg;F
                </div>
                <div class="hv_element">
