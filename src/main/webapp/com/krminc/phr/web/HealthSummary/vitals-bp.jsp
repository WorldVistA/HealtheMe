...
<head>
    ...
    <title>HealtheMe - Health Record - Vitals - Blood Pressure</title>
    ...
    var pagePath = "${ctx_patient}" + "/${it.healthRecordId}/vitals/bloodpressure/";
    var patientId = ${it.healthRecordId};
    var max = ${numResults}; //num per page
    var orderBy = "observeddate"; //must match first item in Sort DDL
    var midPath = "/patients/${it.healthRecordId}/vitals/bloodpressure/";
    var clinPath = "/clinical/vitals/bp/";
    </script>
    <script language="javascript" src="${ctx_static}/js/widget2.js"></script>

</head>
<body id="vitals-bp" class="vitals">
    ...
    <div class="def-container">
        ...
        The measure of how well your circulatory system and heart is functioning.  Systolic readings represent the pressure your heart can produce when contracted, and diastolic readings represents the pressure at rest.  The combination of the two is used in diagnosing many medical conditions.
    </div>
    ...
    <div id="ajax-container">
        <div id="widget-container">
            <div id="bloodpressure-widget" class="widget">
                ...
                <div id="controls">
               		<div class="add">
                    	<a class="addlink" href="${ctx_patient}/${it.healthRecordId}/bloodpressure-add" title="Add Record">Add Record</a>
                    </div>
                  	<div class="sorter">
                        <form id="sorting" action="#" method="post">
                            <label for="sort">Sort by</label>
                            <select name="sort" id="sort">
                                <option value="value" class="selfSort clinicalSort asc">Blood Pressure: ascending</option>
                                <option value="value" class="selfSort clinicalSort desc">Blood Pressure: descending</option>
                        ...
                        <tbody>
                            <tr class="titletemplate selfentered ui-helper-hidden">
                                ...
                                <th class="selfentered col3">
                                	<div class="d">Blood Pressure</div>
                                </th>
                            ...
                            <tr class="rowtemplate selfentered ui-helper-hidden">
                                ...
                                <td class="col3">
                                	<div class="d b">
                                    	<span class="systolic"></span>/<span class="diastolic" ></span>&nbsp;mmHg
                                    </div>
                                </td>
                                <td class="col4">
                                    <div class="d">&nbsp;</div>
                                ...
                                <td class="col5">
                                    <div class="d">
                                        <ul class="actionButtons">
                                            <li class="edit">
                                                <a href="#" class="changelink" title="Edit Blood Pressure Reading"></a>
                                            </li>
                                            <li class="delete">
                                                <a href="#" title="Delete Blood Pressure Reading" class="deletelink"></a>
                                            </li>
                                        </ul>
                                   </div>
                                </td>
