...
$().ready(function() {
        ...
        $("#detailform").validate({
            submitHandler: function(form) {
                ...
                var value = $("#value").val();
                var painid = $("input#painid").val();

                jsonObject = JSON.stringify({
                    "@uri":baseuri +'/vitals/pain/' + painid,
            ...
            messages: {
                ...
                value: {
                    required: 'Please enter a pain level.',
                    digits: 'Please make a selection for pain level.',
                    range: 'Please enter a value in the valid range (0-10).'
                },
                observeddate: {
