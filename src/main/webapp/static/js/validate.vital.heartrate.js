...
$().ready(function() {
        ...
        $("#detailform").validate({
            submitHandler: function(form) {
                ...
                var heartrateid = $("input#heartrateid").val();

                jsonObject = JSON.stringify({
                    "@uri":baseuri +'/vitals/heartrate/' + heartrateid,
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        parent.updateRecord(heartrateid);
                    },
                    error: function() {
            ...
            messages: {
                ...
                rate: {
                    required: 'Please enter a heart rate.',
                    digits: 'Please enter only digits for heart rate.',
                    range: 'Please enter a value in the valid range (30-250).'
                },
                observeddate: {
