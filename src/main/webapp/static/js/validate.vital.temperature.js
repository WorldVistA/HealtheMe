...
$().ready(function() {
        ...
        $("#detailform").validate({
            submitHandler: function(form) {
                ...
                var temperatureid = $("input#temperatureid").val();

                jsonObject = JSON.stringify({
                    "@uri":baseuri +'/vitals/temperature/' + temperatureid,
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        parent.updateRecord(temperatureid);
                    },
                    error: function() {
            ...
            messages: {
                ...
                temperature: {
                    ...
                    number: 'Please enter a decimal number for temperature.',
                    range: 'Please enter a value in the valid range (70-120).'
                },
                observeddate: {
