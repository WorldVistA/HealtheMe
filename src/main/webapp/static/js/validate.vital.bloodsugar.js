...
$().ready(function() {
        ...
        $("#detailform").validate({
            submitHandler: function(form) {
                ...
                var bloodsugarid = $("input#bloodsugarid").val();

                jsonObject = JSON.stringify({
                    "@uri":baseuri +'/vitals/bloodsugar/' + bloodsugarid,
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        parent.updateRecord(bloodsugarid);
                    },
                    error: function() {
            ...
            messages: {
                ...
                unit: {
                    required:'Please enter a blood sugar unit.'
                },
                level: {
                    required:'Please enter a blood sugar level.',
                    digits: 'Please enter only digits for blood sugar level.'
                },
                observeddate: {
