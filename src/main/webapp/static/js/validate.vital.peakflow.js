...
$().ready(function() {
        ...
        $("#detailform").validate({
            submitHandler: function(form) {
                ...
                var peakflow = $("input#peakflow").val();
                var peakflowid = $("input#peakflowid").val();

                jsonObject = JSON.stringify({
                    "@uri":baseuri +'/vitals/peakflow/' + peakflowid,
                    "healthRecordId":patientid,
                    "dataSourceId":datasourceid,
                    "sourceId":sourceid,
                    "id":peakflowid,
                    "observedDate":observeddate,
                    "peakFlow":peakflow},null,1);
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        parent.updateRecord(peakflowid);
                    },
                    error: function() {
            ...
            messages: {
                ...
                peakflow: {
                    required: 'Please enter a peak flow rate.',
                    digits: 'Please enter only digits for peak flow rate.'
                },
                observeddate: {
