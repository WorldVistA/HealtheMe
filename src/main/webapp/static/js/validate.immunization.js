...
$().ready(function() {
        ...
        $("#detailform").validate({
            submitHandler: function(form) {
                ...
                var immunizationid = $("input#immunizationid").val();
                var immunizationtype = $("#immunizationtype").val();
                var datereceived = $("input#datereceived").val();
                var method = $("#method").val();
                var comments = $("#comments").val();
                var reaction = $("#reaction").val();

                jsonObject = JSON.stringify({
                    "@uri":baseuri +'/immunizations/' + immunizationid,
                ...
                $.ajax({
                    ...
                    success: function() {
                        parent.doClose();
                        parent.updateRecord(immunizationid);
                    },
                    error: function() {
		...
		comments: {
            ...
            messages: {
                ...
                immunizationtype: {
                    required:'Please enter an immunization.'
                },
                datereceived: {
