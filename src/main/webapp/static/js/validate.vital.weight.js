...
$().ready(function() {
        ...
        $("#detailform").validate({
            submitHandler: function(form) {
                ...
                var weightid = $("input#weightid").val();

                jsonObject = JSON.stringify({
                    "@uri":baseuri +'/vitals/weight/' + weightid,
            ...
            messages: {
                ...
                unit: {
                    required:'Please enter a weight unit.'
                },
                weight: {
                    required:'Please enter a weight.',
                    digits: 'Please enter only digits for weight.'
                },
                observeddate: {
