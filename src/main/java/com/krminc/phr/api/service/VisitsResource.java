...
import com.krminc.phr.api.converter.VisitsConverter;
import com.krminc.phr.api.converter.VisitConverter;
...
/**
 * Visits API RESTful resource class and mapping.
 *
 * @author cmccall
...
public class VisitsResource {
    ...
    final Logger logger = LoggerFactory.getLogger(VisitsResource.class);
    ...
    /**
     * Get method for retrieving a collection of Visit instance in XML format.
     *
     * @return an instance of VisitsConverter
     */
    @GET
    @Produces( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public VisitsConverter get(
    ...
    /**
     * Post method for creating an instance of Visit using XML as the input format.
     *
     * @param data an VisitConverter entity that is deserialized from an XML stream
     * @return an instance of VisitConverter
     */
    @POST
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public Response post(VisitConverter data) {
    ...
    /**
     * Returns a dynamic instance of VisitResource used for entity navigation.
     *
     * @param id visitId
     * @return an instance of VisitResource
     */
    @Path("{visitId: \\d+}/")
    public VisitResource getVisitResource(@PathParam("visitId") Long id) {
        VisitResource resource = resourceContext.getResource(VisitResource.class);
        resource.setId(id);
        return resource;
    }
    ...
    public JSONObject getCount(
        ...
        result = (Long) em.createNamedQuery("Visit.countByHealthRecordId")
     ...
     *
     * @return a collection of Visit instances
     */
    protected Collection<Visit> getEntities(int start, int max, String source, String orderBy, int desc) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        ...
        StringBuilder query = new StringBuilder("SELECT e FROM Visit e WHERE e.healthRecordId = :healthRecordId");

        if(!orderBy.equalsIgnoreCase("dateadded")){
            query.append(" ORDER BY e.visitDate");
        } else {
     ...
     */
    protected void createEntity(Visit entity) {
