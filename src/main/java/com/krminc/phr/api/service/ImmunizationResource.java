...
/**
 * Immunization API RESTful resource class and mapping.
 *
 * @author Daniel Shaw (dshaw.com)
 */
public class ImmunizationResource {

    final Logger logger = LoggerFactory.getLogger(ImmunizationResource.class);
    ...
    /**
     * Get method for retrieving an instance of Immunization identified by id in XML format.
     *
    ...
    public ImmunizationConverter get() {
        ...
        try {
            ...
            return new ImmunizationConverter(getEntity(), uriInfo.getAbsolutePath(), Api.DEFAULT_EXPAND_LEVEL);
        } finally {
    ...
    /**
     * Put method for updating an instance of Immunization identified by id using XML as the input format.
     *
     * @param data an ImmunizationConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void put(ImmunizationConverter data) {
    ...
    /**
     * Delete method for deleting an instance of Immunization identified by id.
     */
    @DELETE
    public void delete() {
        //check healthrecord is genuine
    ...
    /**
     * Returns an instance of Immunization identified by id.
     *
     * @return an instance of Immunization
     */
    protected Immunization getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            return (Immunization) em.find(Immunization.class, id);
     ...
     */
    protected void deleteEntity(Immunization entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        em.remove(entity);
    }
}
