...
import com.krminc.phr.api.converter.AllergiesConverter;
...
/**
 * Allergies API RESTful resource class and mapping.
 *
 * @author Daniel Shaw (dshaw.com)
 */
public class AllergiesResource {

    final Logger logger = LoggerFactory.getLogger(AllergiesResource.class);
    ...
    /**
     * Get method for retrieving a collection of Allergy instance in XML format.
     *
     * @return an instance of AllergiesConverter
     */
    @GET
    @Produces( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public AllergiesConverter get(
    ...
    /**
     * Post method for creating an instance of Allergy using XML as the input format.
     *
     * @param data an AllergyConverter entity that is deserialized from an XML stream
     * @return an instance of AllergyConverter
     */
    @POST
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public Response post(AllergyConverter data) {
    ...
    /**
     * Returns a dynamic instance of AllergyResource used for entity navigation.
     *
     * @param id allergyId
     * @return an instance of AllergyResource
     */
    @Path("{allergyId: \\d+}/")
    public AllergyResource getAllergyResource(@PathParam("allergyId") Long id) {
        AllergyResource resource = resourceContext.getResource(AllergyResource.class);
        resource.setId(id);
        return resource;
    }
    ...
    public JSONObject getCount(
        ...
        result = (Long) em.createNamedQuery("Allergy.countByHealthRecordId")
     ...
     *
     * @return a collection of Allergy instances
     */
    protected Collection<Allergy> getEntities(int start, int max, String source, String orderBy, int desc) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        ...
        StringBuilder query = new StringBuilder("SELECT e FROM Allergy e WHERE e.healthRecordId = :healthRecordId");

        if(orderBy.equalsIgnoreCase("dateadded")){
            query.append(" ORDER BY e.dateAdded");
        } else if(orderBy.equalsIgnoreCase("name")){
            query.append(" ORDER BY e.allergyText");
        } else {
     ...
     */
    protected void createEntity(Allergy entity) {
        entity.setAllergyId(null);
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        em.persist(entity);
    }
}
