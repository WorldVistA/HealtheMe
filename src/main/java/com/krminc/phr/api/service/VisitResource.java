...
/**
 * Visit API RESTful resource class and mapping.
 *
 * @author cmccall
...
public class VisitResource {
    ...
    final Logger logger = LoggerFactory.getLogger(VisitResource.class);
    ...
    /**
     * Get method for retrieving an instance of Visit identified by id in XML format.
     *
     * @return an instance of VisitConverter
     */
    @GET
    @Produces( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public VisitConverter get() {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new VisitConverter(getEntity(), uriInfo.getAbsolutePath(), Api.DEFAULT_EXPAND_LEVEL);
        } finally {
    ...
    /**
     * Put method for updating an instance of Visit identified by id using XML as the input format.
     *
     * @param data an VisitConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void put(VisitConverter data) {
    ...
    /**
     * Delete method for deleting an instance of Visit identified by id.
     */
    @DELETE
    public void delete() {
        //check healthrecord is genuine
    ...
    /**
     * Returns an instance of Visit identified by id.
     *
     * @return an instance of Visit
     */
    protected Visit getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            return (Visit) em.find(Visit.class, id);
     ...
     */
    protected void deleteEntity(Visit entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        em.remove(entity);
    }
}
