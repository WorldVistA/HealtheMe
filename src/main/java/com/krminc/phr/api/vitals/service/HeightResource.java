...
/**
 * Height API RESTful resource class.
 *
 * @author cmccall
...
public class HeightResource {
    ...
    final Logger logger = LoggerFactory.getLogger(HeightResource.class);
    ...
    /**
     * Get method for retrieving an instance of Height identified by id in XML format.
     *
     * @return an instance of HeightConverter
     */
    @GET
    @Produces( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public HeightConverter get() {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new HeightConverter(getEntity(), uriInfo.getAbsolutePath(), Api.DEFAULT_EXPAND_LEVEL);
        } finally {
    ...
    /**
     * Put method for updating an instance of Height identified by id using XML as the input format.
     *
     * @param data an HeightConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void put(HeightConverter data) {
    ...
    /**
     * Delete method for deleting an instance of Height identified by id.
     */
    @DELETE
    public void delete() {
	//check healthrecord is genuine
    ...
    /**
     * Returns an instance of Height identified by id.
     *
     * @return an instance of Height
     */
    protected Height getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            return (Height) em.find(Height.class, id);
     ...
     */
    protected void deleteEntity(Height entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        em.remove(entity);
    }
}
