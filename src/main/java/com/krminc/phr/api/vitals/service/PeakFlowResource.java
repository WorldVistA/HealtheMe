...
/**
 * Peak Flow API RESTful resource class.
 *
 * @author cmccall
...
public class PeakFlowResource {
    ...
    final Logger logger = LoggerFactory.getLogger(PeakFlowResource.class);
    ...
    /**
     * Get method for retrieving an instance of PeakFlow identified by id in XML format.
     *
     * @return an instance of PeakFlowConverter
     */
    @GET
    @Produces( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public PeakFlowConverter get() {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new PeakFlowConverter(getEntity(), uriInfo.getAbsolutePath(), Api.DEFAULT_EXPAND_LEVEL);
        } finally {
    ...
    /**
     * Put method for updating an instance of PeakFlow identified by id using XML as the input format.
     *
     * @param data an PeakFlowConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void put(PeakFlowConverter data) {
    ...
    /**
     * Delete method for deleting an instance of PeakFlow identified by id.
     */
    @DELETE
    public void delete() {
	//check healthrecord is genuine
    ...
    /**
     * Returns an instance of PeakFlow identified by id.
     *
     * @return an instance of PeakFlow
     */
    protected PeakFlow getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            return (PeakFlow) em.find(PeakFlow.class, id);
     ...
     */
    protected void deleteEntity(PeakFlow entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        em.remove(entity);
    }
}
