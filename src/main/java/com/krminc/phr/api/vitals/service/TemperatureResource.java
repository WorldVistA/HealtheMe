...
/**
 * Temperature API RESTful resource class.
 *
 * @author cmccall
...
public class TemperatureResource {
    ...
    final Logger logger = LoggerFactory.getLogger(TemperatureResource.class);
    ...
    /**
     * Get method for retrieving an instance of Temperature identified by id in XML format.
     *
    ...
    public TemperatureConverter get() {
        ...
        try {
            ...
            return new TemperatureConverter(getEntity(), uriInfo.getAbsolutePath(), Api.DEFAULT_EXPAND_LEVEL);
        } finally {
    ...
    /**
     * Put method for updating an instance of Temperature identified by id using XML as the input format.
     *
     * @param data an TemperatureConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void put(TemperatureConverter data) {
    ...
    /**
     * Delete method for deleting an instance of Temperature identified by id.
     */
    @DELETE
    public void delete() {
	//check healthrecord is genuine
    ...
    /**
     * Returns an instance of Temperature identified by id.
     *
     * @return an instance of Temperature
     */
    protected Temperature getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            return (Temperature) em.find(Temperature.class, id);
     ...
     */
    protected void deleteEntity(Temperature entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        em.remove(entity);
    }
}
