...
/**
 * Blood Pressure API RESTful resource class.
 *
 * @author cmccall
 */
public class BloodPressureResource {

    final Logger logger = LoggerFactory.getLogger(BloodPressureResource.class);
    ...
    /**
     * Get method for retrieving an instance of BloodPressure identified by id in XML format.
     *
    ...
    /**
     * Put method for updating an instance of BloodPressure identified by id using XML as the input format.
     *
     * @param data an BloodPressureConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes( { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void put(BloodPressureConverter data) {
    ...
    /**
     * Delete method for deleting an instance of BloodPressure identified by id.
     */
    @DELETE
    public void delete() {
	//check healthrecord is genuine
    ...
    /**
     * Returns an instance of BloodPressure identified by id.
     *
     * @return an instance of BloodPressure
     */
    protected BloodPressure getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            return (BloodPressure) em.find(BloodPressure.class, id);
     ...
     */
    protected void deleteEntity(BloodPressure entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        em.remove(entity);
    }
}
